...
O tipo-relacionamento \texttt{{ALUNO responde QUESTÃO}} possui os atributos \texttt{Opção} e \texttt{ID\_Resposta}. O atributo \texttt{Opção} é responsável por armazenar qual foi a Opção respondida pelo \texttt{Aluno}, enquanto o \texttt{ID\_Resposta} identifica a resposta do \texttt{Aluno}.
